    ...
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider<UserProfileViewModel>(
              lazy: true,
              create: (_) => GetIt.instance<UserProfileViewModel>()),
          ...
          ChangeNotifierProvider(
              lazy: true,
              create: (_) => GetIt.instance<ManageTaskViewModel>(
                  /*param1: Get.arguments?["toEdit"]  ?? false ,*/)),
          ...
          ChangeNotifierProvider<GetAllIssuesViewModel>(
            lazy: true,
            create: (_) => GetIt.instance<GetAllIssuesViewModel>(),
          ),
          ChangeNotifierProvider<VideoCallViewModel>(
            lazy: true,
            create: (_) => GetIt.instance<VideoCallViewModel>(),
          ),
          ChangeNotifierProvider<MeetingViewModel>(
            lazy: true,
            create: (_) => GetIt.instance<MeetingViewModel>(),
          ),
        ],
